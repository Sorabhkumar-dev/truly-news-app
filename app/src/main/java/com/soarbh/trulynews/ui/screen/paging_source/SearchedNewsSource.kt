...
class SearchedNewsSource constructor(
    private val repository: KtorClientRepository,
    private val searchNewsRequest: SearchNewsRequest
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, Article> {
        return try {
            ...
            val response = repository.getSearchedNews(
                searchNewsRequest.copy(
                    topHeadlineRequest = searchNewsRequest.topHeadlineRequest.copy(
                        page = page,
